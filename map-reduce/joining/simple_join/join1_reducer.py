...
for line in sys.stdin:
    ...
    if curr_word != prev_word:
        ...
        if line_cnt > 1:
            for i in range(len(dates_to_output)):  # loop through dates, indexes start at 0
    ...
    if value_in[0:3] in months:
        # split the value field into a date and day-cnt
        ...
        # if the value field was just the total count then its
